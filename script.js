...
const skillsBtn = document.getElementById("skills-btn");//saya mengubah tambol aktif awal
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const lightLogos = {
    ...
    linkedin: "assets/Instagram_dark.png",
  ...
  const darkLogos = {
    ...
    linkedin: "assets/Instagram_light.png",
...
const textToType = 'sedang mencoba lebih baik';
